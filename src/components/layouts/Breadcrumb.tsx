      ...
      <div className="container mx-auto">
        <ul className="flex">
          ...
          {list ? (
            ...
            <>
              {props.address && props.address.countryCode ? (
                <li className="inline-block">
                  <Link
                    href={props.baseUrl + props.address.countryCode}
                    data-ya-track="Breadcrumbs"
                    eventName={`Breadcrumbs`}
                    rel="noopener noreferrer"
                    conversionDetails={conversionDetailsDirection}
                  >
                    {props.address.countryCode ? props.address.countryCode : ""}
                  </Link>
                </li>
              ) : (
                <></>
          ...
          {list ? (
            ...
            <>
              {props.address && props.address.region ? (
                <li className="inline-block">
                  <Link
                    href={props.baseUrl + props.address.region}
                    data-ya-track="Breadcrumbs"
                    eventName={`Breadcrumbs`}
                    rel="noopener noreferrer"
                    conversionDetails={conversionDetailsDirection}
