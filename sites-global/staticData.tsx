export const StaticData = {
    Meta_title: " Coffe Demo Store - Online Clothes Store",
    Meta_description: "Visit Coffe Demo Store | Coffe is your local great value family retailer shop. Find latest seasonal looks for Women, Men and kids, plus a huge range of homeware.",
